 ...
 * @hidden
 */
export declare const useRtl: (elementRef: React.RefObject<HTMLElement>, initialDir?: string) => string;
/**
 ...
 */
export declare function useAsyncFocusBlur<T extends any[]>({ onFocus, onBlur }: {
