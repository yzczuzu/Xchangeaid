...
function DescendantProvider(_ref2) {
  var Ctx = _ref2.context,
      ...
      items = _ref2.items,
      set = _ref2.set;
  var registerDescendant = React.useCallback(function (_ref3) {
...
export { DescendantProvider, createDescendantContext, useDescendant, useDescendantKeyDown, useDescendants };
